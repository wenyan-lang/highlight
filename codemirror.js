...
CodeMirror.defineSimpleMode('wenyan', {
  ...
  start: [
    ...
    { regex: /不知何禍歟|不復存矣|如事不諧|姑妄行此|吾嘗觀|之禍歟|乃作罷|名之曰|書之|以施|之禍|嗚呼|之義|昔之|方悟|是矣|今有|吾有|之書|物之|中|今|取|噫|曰|施|豈|有/, token: 'builtin' },
    { regex: /乃行是術曰|若其不然者|乃止是遍|乃歸空無|欲行是術|若其然者|其物如是|乃得矣|恆為是|之術也|必先得|是術曰|之物也|云云|中之|為是|乃止|若非|或若|乃得|是謂|者|若|遍|凡|也/, token: 'keyword' },
